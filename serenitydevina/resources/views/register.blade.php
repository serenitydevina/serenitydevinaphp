                            ...
                            <div class="card-body">
                                ...
                                {{ csrf_field() }}
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputFirstName" type="text" name="name" placeholder="Masukkan Nama" value="{{ old('name') }}"/>
                                         @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputEmailAddress" type="email" aria-describedby="emailHelp" name="email" value="{{old('email')}}" placeholder="Masukkan Email" />
                                        @if ($errors->has('email'))
